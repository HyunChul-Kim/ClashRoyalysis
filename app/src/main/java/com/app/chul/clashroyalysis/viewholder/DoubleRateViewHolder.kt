...
class DoubleRateViewHolder(itemView: View, _leftTitle: String, _rightTitle: String): RecyclerView.ViewHolder(itemView) {
    ...
    private val leftProgress = itemView.findViewById<ProgressView>(R.id.left_progress)
    private val rightProgress = itemView.findViewById<ProgressView>(R.id.right_progress)
